...
General idea of Tibor's paper is that Bland, LIFO, MOSV are belong to s-Monotone rules, and proved s-Monotone rule is finite. And propose the guidance of how to revise other pivot rule, such as steepest edge rule, to be finite (combining with LIFO or MOSV). I will write in more detail.
